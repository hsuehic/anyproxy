...
function printLog(content, type) {
  ...
  switch (type) {
    case LogLevelMap.tip: {
      ...
      console.log(color.cyan(`[ACPP Log][${timeString}]: ` + content));
      break;
    }
    ...
    case LogLevelMap.system_error: {
      ...
      console.error(color.red(`[ACPP ERROR][${timeString}]: ` + content));
      break;
    }
    ...
    case LogLevelMap.rule_error: {
      ...
      console.error(color.red(`[ACPP RULE_ERROR][${timeString}]: ` + content));
      break;
    }
    ...
    case LogLevelMap.warn: {
      ...
      console.error(color.yellow(`[ACPP WARN][${timeString}]: ` + content));
      break;
    }
